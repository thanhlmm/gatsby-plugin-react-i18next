...
var onCreateNode = /*#__PURE__*/ (function () {
  var _ref4 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee(_ref2, _ref3) {
      var node,
        actions,
        loadNodeContent,
        createNodeId,
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                (_ref3$localeJsonSourc = _ref3.localeJsonSourceName),
                  (localeJsonSourceName =
                    _ref3$localeJsonSourc === void 0 ? 'locale' : _ref3$localeJsonSourc);
              ...
              case 4:
                (absolutePath = node.absolutePath),
                  (_node$internal = node.internal),
                  (mediaType = _node$internal.mediaType),
                  (type = _node$internal.type),
                  (sourceInstanceName = node.sourceInstanceName),
                  (relativeDirectory = node.relativeDirectory),
                  (name = node.name),
                  (id = node.id); // Currently only support file resources
