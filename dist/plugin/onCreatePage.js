...
var onCreatePage = /*#__PURE__*/ (function () {
  var _ref2 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee3(_ref, pluginOptions) {
      var page,
        actions,
        createPage,
        deletePage,
          ...
          switch ((_context3.prev = _context3.next)) {
            ...
            case 3:
              ...
              (_pluginOptions$defaul = pluginOptions.defaultLanguage),
                ...
                (_pluginOptions$genera = pluginOptions.generateDefaultLanguagePage),
                (generateDefaultLanguagePage =
                  _pluginOptions$genera === void 0 ? false : _pluginOptions$genera),
                        ...
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            (language = _ref3.language),
                              ...
                              (path = _ref3$path === void 0 ? page.path : _ref3$path),
                              (_ref3$originalPath = _ref3.originalPath),
                              (originalPath =
                                _ref3$originalPath === void 0 ? page.path : _ref3$originalPath),
                              (_ref3$routed = _ref3.routed),
                              (routed = _ref3$routed === void 0 ? false : _ref3$routed),
                              (pageOptions = _ref3.pageOptions);
              ...
              if (pageOptions !== null && pageOptions !== void 0 && pageOptions.languages) {
                alternativeLanguages = generateDefaultLanguagePage
                  ...
                  : pageOptions.languages.filter(function (lng) {
                      return lng !== defaultLanguage;
                    });
              }

              if (
                !(pageOptions !== null && pageOptions !== void 0 && pageOptions.getLanguageFromPath)
              ) {
                _context3.next = 23;
                break;
              }
              ...
              return _bluebird.default.map(
                ...
                /*#__PURE__*/ (function () {
                  var _ref5 = (0, _asyncToGenerator2.default)(
                    /*#__PURE__*/ _regenerator.default.mark(function _callee2(lng) {
